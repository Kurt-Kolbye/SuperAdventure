...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        //********REFACTOR INTO SEPARATE FUNCTIONS/METHODS TO IMRPOVE QUALITY********
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            // Display message
            rtbMessages.Text += "You hit the " + currentMonster.Name + " for " + 
            ...
            if (currentMonster.CurrentHitPoints <= 0)
            {
                ...
                rtbMessages.Text += "You receive " + currentMonster.RewardExperiencePoints.ToString() + 
                    " experience points" + Environment.NewLine;

                // Give player gold for killing the monster 
                player.Gold += currentMonster.RewardGold;
                rtbMessages.Text += "You receive " + currentMonster.RewardGold.ToString() + " gold" + 
                    Environment.NewLine;
            ...
            else
            {
                ...
                // Display message
                rtbMessages.Text += "The " + currentMonster.Name + " did " + damageToPlayer.ToString() + 
